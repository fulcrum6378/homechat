...
public class Prefs extends PreferenceActivity implements OnSharedPreferenceChangeListener {
    ...
    private void checkTimeout() {
        EditTextPreference timeout = (EditTextPreference) ps.findPreference(Prefs.KEY_TIMEOUT_DISCOVER);
        CheckBoxPreference cb = (CheckBoxPreference) ps.findPreference(Prefs.KEY_RATECTRL_ENABLE);
        timeout.setEnabled(!cb.isChecked());
    }
